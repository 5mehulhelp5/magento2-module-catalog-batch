# kingletas/module-catalog-batch
#
...
SUITE_all         := Test/Unit Test/Wiring Test/Performance
...
help: ## Show this help
	@echo
	@echo "  kingletas/module-catalog-batch"
	@echo
...
check: cs test ## Everything a commit has to pass
	@echo
	@echo "  the standard and $(SUITE_LABEL) pass for catalog-batch"
